...
description: "Image and video perceptual hashing and matching — the axis hashkit, hashkit-match, and csam-shield build on."
---
...
**12 projects** — 11 learn from · 1 reference.
...
**Learn from** · by Wikimedia Foundation · pairs with [csam-shield](/docs/csam-shield)

A production child-protection scanning integration wired straight into a major platform's upload + review pipeline (PhotoDNA-based in Wikimedia's deployment). It's the real-world shape of the detect → flag → human-review flow that csam-shield generalizes platform-agnostically — a useful reference even though it's MediaWiki-specific.

> A MediaWiki extension that scans uploaded media to support the Wikimedia Foundation's child-protection workflows.
