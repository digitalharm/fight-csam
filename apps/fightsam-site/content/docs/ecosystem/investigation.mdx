...
description: "Threat-signal sharing and investigation tooling. Meta ThreatExchange / python-threatexchange set the bar for hashstream; disinformation and platform-o"
---
...
Solid tooling for the disinformation and influence-operations research community, but coordinated inauthentic behavior is deliberately outside FightSAM's remit, which centers on CSAM detection, reporting, and prevention. Different problem, different field.
...
Valuable work on algorithmic transparency and recommender-system observability, but that disinformation and election-integrity focus sits outside FightSAM's CSAM-centric scope. We point to it respectfully rather than fold it in.
...
A useful collaborative investigation surface, but its deepfake and synthetic-media analysis focus is a different problem from FightSAM's CSAM detection and reporting mission. Worthwhile in its own lane.
...
Important election-integrity and foreign-influence research, but tracking interference campaigns falls outside FightSAM's CSAM scope. We credit the work without treating it as part of our toolchain.
...
A capable platform-observability and trend-investigation toolkit, but its disinformation and harmful-narrative focus is deliberately outside FightSAM's CSAM-centric mission. Valuable work on an adjacent problem.
...
Sharp work on recommender-system accountability and platform observability, but algorithmic promotion/demotion on TikTok is outside FightSAM's CSAM detection and reporting scope. We acknowledge it as strong work on a different question.
