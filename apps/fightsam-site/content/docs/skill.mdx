...
description: A Claude Agent Skill that teaches your coding agent to wire CSAM safety with the FightSAM tools and the right ecosystem tools — correct installs, gates honored.
---

**`csam-safety`** is a Claude Agent Skill. Drop it into your coding agent and it
already knows the 11 FightSAM tools, the top ecosystem tools, the golden-path
...
- **The 11 FightSAM tools** — purpose, verified install/import commands, when to use each, and current status/gates.
...
It ships in the FightSAM repo under `.claude/skills/csam-safety`. Copy it into
...
Fediverse moderation — even if you don't mention "FightSAM" or "CSAM".
